...
function menuSongCreator() {
  songList.forEach((song) => {
    modalMenuContainer.insertAdjacentHTML(
      "beforeend",
...
function playThisSong(e) {
  ...
  let indexMainSong = songList.findIndex(
    (songData) => mainSongName === songData.title
  );
...
timeBar.addEventListener("click", (e) => {
  songElem.currentTime = Math.round(
    (e.offsetX / e.target.offsetWidth) * timeBar.max
  );
